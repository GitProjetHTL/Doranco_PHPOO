...
$fraisier= new Gateau("fraisier",14);
$ingredient= new Ingredient("fraise",5);

$fraisier->couperGateau(8);
echo $fraisier->distribuerGateau(14);
echo "<br>";
var_dump($fraisier);
echo "<br>";
echo "<br>";
...
echo $fraisier-> cuisinergateau($ingredient);
